    ...
    <x-slot:title>{{ $title }}</x-slot:title>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-0">
            <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article class="p-6 bg-white rounded-xl border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a class="hover:underline" href="/posts/{{ $post ['slug'] }}">{{ Str::limit($post['title'], 25) }}</a></h2>
                ...
                <p><a href="/posts" class="hover:underline text-blue-600">&laquo; Back to Posts</a></p> 
